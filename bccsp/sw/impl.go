...
var (
    logger = zlog.New("fabric_msp", "bccsp_sw")
)
...
func NewDefaultSecurityLevel(keyStorePath string) (bccsp.BCCSP, error) {
    ...
    if err := ks.Init(nil, keyStorePath, false); err != nil {
        return nil, fmt.Errorf("failed initializing key store at [%v]", err)
    }
...
func New(securityLevel int, hashFamily string, keyStore bccsp.KeyStore) (bccsp.BCCSP, error) {
    ...
    if err != nil {
        return nil, fmt.Errorf("failed initializing configuration at [%v,%v]", err)
    }
...
func (csp *impl) KeyGen(opts bccsp.KeyGenOpts) (k bccsp.Key, err error) {
    ...
    if err != nil {
        return nil, fmt.Errorf("failed generating key with opts [%v]", err)
    }
    ...
    if !opts.Ephemeral() {
        ...
        if err != nil {
            return nil, fmt.Errorf("failed storing key for [%s]", err)
        }
    }
...
func (csp *impl) KeyDeriv(k bccsp.Key, opts bccsp.KeyDerivOpts) (dk bccsp.Key, err error) {
    ...
    if err != nil {
        return nil, fmt.Errorf("failed deriving key with opts [%v]", err)
    }
...
func (csp *impl) KeyImport(raw interface{}, opts bccsp.KeyImportOpts) (k bccsp.Key, err error) {
    // Validate arguments
    if raw == nil {
        return nil, fmt.Errorf("invalid raw. It must not be nil")
    }
    if opts == nil {
        return nil, fmt.Errorf("invalid opts. It must not be nil")
    }
    ...
    if err != nil {
        return nil, fmt.Errorf("failed importing key with opts [%v]", err)
    }
    ...
    if !opts.Ephemeral() {
        ...
        err = csp.ks.StoreKey(k)
        if err != nil {
            return nil, fmt.Errorf("failed storing imported key with opts [%v]", err)
        }
    }
...
func (csp *impl) GetKey(ski []byte) (k bccsp.Key, err error) {
    ...
    if err != nil {
        return nil, fmt.Errorf("failed getting key for SKI [%v]", err)
    }
...
func (csp *impl) Hash(msg []byte, opts bccsp.HashOpts) (digest []byte, err error) {
    ...
    if err != nil {
        return nil, fmt.Errorf("failed hashing with opts [%v]", err)
    }
...
func (csp *impl) GetHash(opts bccsp.HashOpts) (h hash.Hash, err error) {
    ...
    if err != nil {
        return nil, fmt.Errorf("failed getting hash function with opts [%v]", err)
    }
...
func (csp *impl) Sign(k bccsp.Key, digest []byte, opts bccsp.SignerOpts) (signature []byte, err error) {
    ...
    if err != nil {
        return nil, fmt.Errorf("failed signing with opts [%v]", err)
    }
...
func (csp *impl) Verify(k bccsp.Key, signature, digest []byte, opts bccsp.SignerOpts) (valid bool, err error) {
    ...
    if err != nil {
        return false, fmt.Errorf("failed verifing with opts [%v]", err)
    }
...
func (csp *impl) Decrypt(k bccsp.Key, ciphertext []byte, opts bccsp.DecrypterOpts) (plaintext []byte, err error) {
    ...
    if err != nil {
        return nil, fmt.Errorf("failed decrypting with opts [%v]", opts)
    }
